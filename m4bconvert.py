...
def process_audiobook(filename, a_meta_data):
  ...
  if exitcode == 0:
    ...
    fileinfo['activation_bytes'] = 'not needed for m4b'
...
if __name__ == "__main__":
  ...
  cmd_line = 'Command Line is: ' + sys.argv[0] + ' path_to_filename.m4b\n'

  if len(sys.argv) == 2:
    if len(sys.argv[1]) >= 4:
      if sys.argv[1][-4:].lower() == '.m4b':
        if os.path.isfile(sys.argv[1]):
          if not os.path.isfile(sys.argv[1] + '.processed'):
            print "M4B = " + sys.argv[1]
            a_meta_data = {}
            ...
            print note
            print cmd_line
            print 'Error: The m4b file has a .processed file meaning it\'s already been worked on.'
        else:
          print note
          print cmd_line
        ...
        print note
        print cmd_line
        print 'Error: I did not receive an m4b file.'
    else:
      print note
      print cmd_line
      print 'Error: I did not receive an m4b file.'
